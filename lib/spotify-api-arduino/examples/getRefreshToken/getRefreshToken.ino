...
char ssid[] = "SSID";         // SSID da sua rede (nome)
char password[] = "password"; // senha da sua rede

char clientId[] = "68933654dc544df38ece84a8e49faeca";     // ID do cliente do seu aplicativo do Spotify
char clientSecret[] = "e5122fc865b1482881cbe85288f632d0"; // Segredo do cliente do seu aplicativo do Spotify (Não compartilhe isso!)
